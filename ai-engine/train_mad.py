...
def main() -> None:
    ...
    parser.add_argument("--spec-aug", action="store_true", default=True, help="Apply SpecAugment during training (on by default)")
    parser.add_argument("--no-spec-aug", dest="spec_aug", action="store_false", help="Disable SpecAugment")
